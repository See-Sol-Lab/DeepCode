# Agent Note: DeepCode desktop UI state, window geometry, themes, and launcher rescue

Status: implemented

English | [中文](2026-08-16-deepcode-b2-p1-ui-state-and-daily-ux.zh.md)
