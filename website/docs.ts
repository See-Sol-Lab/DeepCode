...
const homeAndGuide = pairedPages([
  {
    ...
    route: 'index.md',
    label: { root: 'DeepCode', en: 'DeepCode' },
    sidebar: { root: null, en: null },
    section: { root: '首页', en: 'Home' },
    order: 0,
  },
  {
    source: 'docs/user/deepcode/quickstart.md',
  ...
  {
    source: 'docs/user/deepcode/models.md',
    route: 'guide/models.md',
    label: { root: '模型与视觉', en: 'Models and vision' },
    sidebar: { root: 'zh-guide', en: 'en-guide' },
    section: { root: '使用 DeepCode', en: 'Use DeepCode' },
    order: 1,
  },
  {
    source: 'docs/user/deepcode/workspaces-sessions.md',
  ...
  {
    source: 'docs/user/deepcode/profiles-plugins.md',
  ...
  {
    source: 'docs/user/deepcode/permissions.md',
  ...
  {
    source: 'docs/user/deepcode/desktop-tools.md',
  ...
  {
    source: 'docs/user/deepcode/data-troubleshooting.md',
...
const sections: Record<DocsLocale, readonly DocsSection[]> = {
  root: [
    { label: '开始使用' }, { label: '使用 DeepCode' }, { label: '帮助' }, { label: 'Harness' }, { label: 'SDK' },
  ...
  en: [
    { label: 'Get started' }, { label: 'Use DeepCode' }, { label: 'Help' }, { label: 'Harness' }, { label: 'SDK' },
