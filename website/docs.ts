...
const homeAndGuide = pairedPages([
  {
    ...
    route: 'index.md',
    label: { root: 'DeepSeekGUI', en: 'DeepSeekGUI' },
    sidebar: { root: null, en: null },
    section: { root: '首页', en: 'Home' },
    order: 0,
  },
  {
    source: 'docs/user/deepseekgui/quickstart.md',
    route: 'guide/quickstart.md',
    label: { root: '快速开始', en: 'Quick start' },
    sidebar: { root: 'zh-guide', en: 'en-guide' },
    section: { root: '开始使用', en: 'Get started' },
    order: 1,
  },
  {
    source: 'docs/user/deepseekgui/models.md',
    route: 'guide/models.md',
    label: { root: '模型与视觉', en: 'Models and vision' },
    sidebar: { root: 'zh-guide', en: 'en-guide' },
    section: { root: '使用 DeepSeekGUI', en: 'Use DeepSeekGUI' },
    order: 1,
  },
  {
    source: 'docs/user/deepseekgui/workspaces-sessions.md',
    route: 'guide/workspaces-sessions.md',
    label: { root: '工作区与会话', en: 'Workspaces and sessions' },
    sidebar: { root: 'zh-guide', en: 'en-guide' },
    section: { root: '使用 DeepSeekGUI', en: 'Use DeepSeekGUI' },
    order: 2,
  },
  {
    source: 'docs/user/deepseekgui/profiles-plugins.md',
    route: 'guide/profiles-plugins.md',
    label: { root: 'Profile 与插件', en: 'Profiles and plugins' },
    sidebar: { root: 'zh-guide', en: 'en-guide' },
    section: { root: '使用 DeepSeekGUI', en: 'Use DeepSeekGUI' },
    order: 3,
  },
  {
    source: 'docs/user/deepseekgui/permissions.md',
    route: 'guide/permissions.md',
    label: { root: '权限与批准', en: 'Permissions and approvals' },
    sidebar: { root: 'zh-guide', en: 'en-guide' },
    section: { root: '使用 DeepSeekGUI', en: 'Use DeepSeekGUI' },
    order: 4,
  },
  {
    source: 'docs/user/deepseekgui/desktop-tools.md',
    route: 'guide/desktop-tools.md',
    label: { root: '桌面工具', en: 'Desktop tools' },
    sidebar: { root: 'zh-guide', en: 'en-guide' },
    section: { root: '使用 DeepSeekGUI', en: 'Use DeepSeekGUI' },
    order: 5,
  },
  {
    source: 'docs/user/deepseekgui/data-troubleshooting.md',
    route: 'guide/data-troubleshooting.md',
    label: { root: '数据与故障排查', en: 'Data and troubleshooting' },
    sidebar: { root: 'zh-guide', en: 'en-guide' },
    section: { root: '帮助', en: 'Help' },
    order: 1,
  },
  {
    source: 'docs/user/guide/index.md',
    route: 'guide/harness-web-ui.md',
    label: { root: 'Harness Web UI', en: 'Harness Web UI' },
    sidebar: { root: 'zh-guide', en: 'en-guide' },
    section: { root: 'Harness', en: 'Harness' },
    order: 1,
  ...
  },
  {
    ...
    label: { root: 'Harness 提供方配置', en: 'Harness provider configuration' },
    sidebar: { root: 'zh-guide', en: 'en-guide' },
    section: { root: 'Harness', en: 'Harness' },
    order: 2,
  },
...
const sections: Record<DocsLocale, readonly DocsSection[]> = {
  root: [
    { label: '开始使用' }, { label: '使用 DeepSeekGUI' }, { label: '帮助' }, { label: 'Harness' }, { label: 'SDK' },
  ...
  en: [
    { label: 'Get started' }, { label: 'Use DeepSeekGUI' }, { label: 'Help' }, { label: 'Harness' }, { label: 'SDK' },
