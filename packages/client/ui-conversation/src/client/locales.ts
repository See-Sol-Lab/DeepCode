...
export const zh = {
  ...
  'access.option.read-only': '只读',
  'access.option.workspace-write': '工作区写入',
  'access.option.danger-full-access': '完全访问（高风险）',
  'access.optionDesc.read-only': '只读取和分析文件，不做任何修改',
  'access.optionDesc.workspace-write': '可以修改工作区里的文件，其他操作会先询问',
  'access.optionDesc.danger-full-access': '可以不受限制地执行命令、访问你电脑上的任何文件',
...
export const en = {
  ...
  'access.option.read-only': 'Read Only',
  'access.option.workspace-write': 'Workspace Write',
  'access.option.danger-full-access': 'Full access (High risk)',
  'access.optionDesc.read-only': 'Reads and analyzes files; never makes changes',
  'access.optionDesc.workspace-write': 'Can edit files in the workspace; asks first for anything else',
  'access.optionDesc.danger-full-access': 'Unrestricted commands and access to any file on your computer',
